...
public class vThirdPersonCamera : MonoBehaviour
{
   ...
   // private float scrollF = 0;
    ...
    {
        target = target == null ? newTarget : target;
        currentTarget = target;
    ...
    public void ScrollCamera(float x)
    {
        defaultDistance -= x * Time.deltaTime * 400;
        defaultDistance = Mathf.Clamp(defaultDistance, 0, 15);
    }
